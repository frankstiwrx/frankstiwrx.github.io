...
const itens = [
    {name: 'Bacon House', price: '12.90', image: 'x-bacon.jpg'},
    {name: 'Double Smash', price: '14.90', image: 'double-x.jpg'},
    {name: 'Classic House', price: '16.90', image: 'o-burger-x.jpg'},
    {name: 'Cheese Burger', price: '12.90', image: 'x-burger.jpg'},
    {name: 'Future Burger', price: '17.50', image: 'x-futuro.jpg'},
    {name: 'Fresh Burger', price: '22.99', image: 'x-salada.jpg'},
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    itens.forEach(({name, price, image}) => {
        ...
        output += `<div class="item-card">
                ...
                <img class="item-image" src="assets/${image}" alt="${name}">
